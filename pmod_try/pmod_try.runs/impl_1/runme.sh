...
HD_PWD='C:/Users/llaaj/OneDrive/Documentos/GitHub/Arqui2/pmod_try/pmod_try.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log prueba.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source prueba.tcl -notrace
